...
export class GameOver extends Scene {
    ...
    init() {
        ...
        this.player.y = this.game.screen.height - 20 - this.player.view.height;
    ...
    render(time) {
        ...
        this.game.screen.drawImage(60, 100 + this.game.screen.images.sky1.height , 'cloudLogo');
        this.game.screen.drawImage(this.game.screen.canvas.width - this.game.screen.images.sky3.width + 20, this.game.screen.images.sky1.height - 40 , 'sky3');
        ...
        this.game.screen.drawImage(this.game.screen.canvas.width/2 - this.game.screen.images.textGameOver.width/2, 150 , 'textGameOver');
        this.game.screen.printText(280, 230, 'Лама уснула');
        this.game.screen.printText(240, 260,  'и ты тоже засыпай!')
        this.game.screen.printText(240, 290, 'Встретимся завтра');
        this.game.screen.printText(260, 320, 'в этоже время!');
